...
static const int64_t MAX_MONEY = 58000000 * COIN; // Murraycoin: maximum of 58M coins, max transaction 58,000,000
...
public:
    ...
    {
        // Murraycoin: IsDust() detection disabled, allows any valid dust to be relayed.
