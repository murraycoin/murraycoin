...
static const int64_t DUST_SOFT_LIMIT = 1000000; // 0.01 MRY
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64_t DUST_HARD_LIMIT = 10000;   // 0.0001 MRY mininput
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 100;
/** Coinbase maturity after block 130000 **/
static const int COINBASE_MATURITY_NEW = 100;
/** Block at which COINBASE_MATURITY_NEW comes into effect **/
static const int COINBASE_MATURITY_SWITCH = 130000;
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // Murraycoin: 1440 blocks found a day. Priority cutoff is 100 murraycoin day / 250 bytes.
    }
 ...
 */
// Murraycoin specific implementation, standardizes checks for the hard maturity change at block 145k
