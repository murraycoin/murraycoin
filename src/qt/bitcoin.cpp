...
/** Class encapsulating Murraycoin startup and shutdown.
...
/** Main Murraycoin application object */
...
*/
        ...
        // murraycoin: URIs or payment requests:
        /*
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Murraycoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr("Murraycoin"),
    ...
    if (!SelectParamsFromCommandLine()) {
        QMessageBox::critical(0, QObject::tr("Murraycoin"), QObject::tr("Error: Invalid combination of -regtest and -testnet."));
        return 1;
    }
#ifdef ENABLE_WALLET
    ...
    // murraycoin: links repeatedly have their payment requests routed to this process:
