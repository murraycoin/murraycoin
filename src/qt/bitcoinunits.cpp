...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MRY);
    unitlist.append(mMRY);
    unitlist.append(uMRY);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MRY: return QString("MRY");
    case mMRY: return QString("mMRY");
    case uMRY: return QString::fromUtf8("μMRY");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MRY: return QString("Murraycoins");
    case mMRY: return QString("Milli-Murraycoins (1 / 1000 MRY)");
    case uMRY: return QString("Micro-Murraycoins (1 / 1000000 MRY)");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MRY:  return 100000000;
    case mMRY: return 100000;
    case uMRY: return 100;
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MRY:  return Q_INT64_C(58000000);
    case mMRY: return Q_INT64_C(58000000000);
    case uMRY: return Q_INT64_C(58000000000000);
    default:   return 0;
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MRY: return 8; // 58,000,000 (# digits, without commas)
    case mMRY: return 11; // 58,000,000,000
    case uMRY: return 14; // 58,000,000,000,000
    default: return 0;
    }
}
