...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Murraycoin"),
     ...
     * override -datadir in the murraycoin.conf file in the default data directory
     * (to be consistent with murraycoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
