    ...
    transactionView(0)
{
	...
	QAction *viewOnMurraychain = new QAction(tr("View transaction on Murraycoin Explorer"), this);
    ...
    contextMenu->addAction(viewOnMurraychain);
	...
	connect(viewOnMurraychain, SIGNAL(triggered()), this, SLOT(viewOnMurraychain()));
}
...
void TransactionView::setModel(WalletModel *model)
{
	...
	transactionView->setColumnWidth(TransactionTableModel::ToAddress, QHeaderView::Stretch);
...
void TransactionView::viewOnMurraychain()
{
    QModelIndexList selection = transactionView->selectionModel()->selectedRows();
    if(!selection.isEmpty())
    {
        QString format("http://explorer.murraycoin.org/tx/");
